...
7. Check out [README.md](./generators/app/templates/repository/README.md) or see the docs below.
...
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](./generators/app/templates/repository/LICENSE) [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/dev-experience/xapi-roomkit-macro-debugging/blob/master/.github/CONTRIBUTING.md)
...
![CE Macro Editor](./generators/app/templates/repository/docs/img/ce-macro-editor.jpg)
...
1. Keep your macros in files. It makes easy to commit your changes to GIT for change history.
    ...
    ![Git history](./generators/app/templates/repository/docs/img/git-history.png)

2. Run your macros from your local machine in Visual Studio Code.

    ![Run xapi macro in Visual Studio Code](./generators/app/templates/repository/docs/img/vs-code_run.gif)

3. Use code completion for JavaScript in Visual Studio Code.

    ![Code completion in Visual Studio Code](./generators/app/templates/repository/docs/img/vs-code_code-completion.gif)
...
4. Debug your macros:
    ...
    ![Step-by-step execution, watching variable values in Visual Studio Code](./generators/app/templates/repository/docs/img/vs-code_step-by-step.gif)

5. Use `await` for promises to simplify your code.

    ![Async/await for promises in Visual Studio Code](./generators/app/templates/repository/docs/img/vs-code_async-await.gif)
...
1. Install Visual Studio Code with JavaScript support:
    ...
    <img src="./generators/app/templates/repository/docs/img/vs-code-18x18.png" height="18" /> Visual Studio Code
    
    https://code.visualstudio.com/download
    
2. Install Node.js with NPM:

    <img src="./generators/app/templates/repository/docs/img/nodejs-logo-color.svg" height="18" /> <img src="./generators/app/templates/repository/docs/img/npm-logo-red.svg" height="12" />
...
- Open the directory in Visual Studio Code.
    ...
    ![Open directory in Visual Studio Code](./generators/app/templates/repository/docs/img/vs-code_open-folder.gif)

- Open sample macro './macros/1-showVolume.js'.

    ![Open macro './macros/1-showVolume.js' in Visual Studio Code](./generators/app/templates/repository/docs/img/vs-code_open-macro.gif)

- Put a breakpoint on any `console.log(...)` statement by pressing 'F9'.

    ![Put a breakpoint on any console.log statement by pressing 'F9'](./generators/app/templates/repository/docs/img/vs-code_put-breakpoint.gif)
...
## Template files ([see](./generators/app/templates/repository/))

- *[README.md](./generators/app/templates/repository/README.md)*

  Current docs.

- *[package.json](./generators/app/templates/repository/package.json)*

  Metadata and dependencies definition. Run `npm install` once to install `jsxapi`.

- *[.gitignore](./generators/app/templates/repository/.gitignore)*

  Excludes particular files and directories from GIT commits. Help to make your repository clean and tidy.

- *[.vscode/launch.json](./generators/app/templates/dotfiles/__vscode/launch.json)*

  Launch configuration for Visual Studio Code. Enables debugging by 'F5'

- *[_bootstrap.js](./generators/app/templates/repository/_bootstrap.js)*
...
- *[.env](./generators/app/templates/dotfiles/__env)*
...
- *[macros/](./generators/app/templates/repository/macros)*

  **Put all your macros there**

    - *[macros/1-showVolume.js](./generators/app/templates/repository/macros/1-showVolume.js)*

      Sample macro to check out debugging capabilities.

    - *[macros/0-emptyMacro.js](./generators/app/templates/repository/macros/0-emptyMacro.js)*

      **Copy this one to create your new macro**.

- *[docs/](./generators/app/templates/repository/docs)*

  Documentation files.

- *[macro-tutorial.pdf](./generators/app/templates/repository/macro-tutorial.pdf)*
